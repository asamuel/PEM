   ...
   (function(symbolName) {
      ...
      Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function(sym, e) {
       //Declaramos variables globales
         ...
         //Imaginacion
         /*sym.getSymbol("simCont").getSymbol("simImaginacion").$("fondo1").wrap( "<a href=\"Pem20/Pem20.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simImaginacion").$("fondo2").wrap( "<a href=\"Pem25/Pem25.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simImaginacion").$("fondo3").wrap( "<a href=\"Pem165/Pem165.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simImaginacion").$("fondo4").wrap( "<a href=\"Pem28/Pem28.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simImaginacion").$("fondo5").wrap( "<a href=\"Pem20_1/Pem1_1.php\"  target='_self'></a>" );
         
         sym.getSymbol("simCont").getSymbol("simImaginacion").$("fondo6").wrap( "<a href=\"Pem156/Pem156.php\"  target='_self'></a>" );
 
         //Razonamiento
         sym.getSymbol("simCont").getSymbol("simRazonamientoM").$("fondo1").wrap( "<a href=\"Pem94/Pem94.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simRazonamientoM").$("fondo2").wrap( "<a href=\"Pem96/Pem96.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simRazonamientoM").$("fondo3").wrap( "<a href=\"Pem108/Pem108.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simRazonamientoM").$("fondo4").wrap( "<a href=\"Pem35/Pem35.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simRazonamientoM").$("fondo6").wrap( "<a href=\"Pem38/Pem38.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simRazonamientoM").$("fondo7").wrap( "<a href=\"Pem104-105/Pem104-105.php\"  target='_self'></a>" );
 
 
         //Calculo
         sym.getSymbol("simCont").getSymbol("simCalculo").$("fondo1").wrap( "<a href=\"Pem22/Pem2.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simCalculo").$("fondo2").wrap( "<a href=\"Pem24/Pem24.php\"  target='_self'></a>" );
 
         sym.getSymbol("simCont").getSymbol("simCalculo").$("fondo3").wrap( "<a href=\"Pem171/Pem171.php\"  target='_self'></a>" );
 
   		  sym.getSymbol("simCont").getSymbol("simCalculo").$("fondo4").wrap( "<a href=\"Pem71/Pem71.php\"  target='_self'></a>" );
 
   		  sym.getSymbol("simCont").getSymbol("simCalculo").$("fondo5").wrap( "<a href=\"Pem193/Pem193.php\"  target='_self'></a>" );
 
   		  sym.getSymbol("simCont").getSymbol("simCalculo").$("fondo6").wrap( "<a href=\"Pem81-82-84/Pem81-82-84.php\"  target='_self'></a>" );*/
          ...
          "<a href=\"creditos.php\"  target='_self'></a>" );*/
